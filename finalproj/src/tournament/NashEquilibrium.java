...
//     }
//
//     private NashEquilibrium(MatrixGame mg){
...
//     }
//
//     private boolean isNashEquilibrium(MatrixGame mg){
//       // Is the solution a nash equilibrium
//       double[] x = findMaxEachRow();
//     }
//
...
//     }
//
//     private double[][] getPayoffColumns(int act){
//       // Get payoff values for columns
//       double[] colPayoff = new double[act];
//       for(int col = 1; col <= act; col++){
//         outcome[0] = row;
//         outcome[1] = col;
//         mg.getPayoff(outcome, playerNumber);
//       }
//     }
//
...
//
//         //Nash
//         private LinearProgramming(matrixGame mg, int playerNumber){
//           int n = mg.getNumActions(playerNumber);  //length of actions
//
//           // Create a basis
//           basis = new int[n];
//           for (int i=0; i < n; i++) {
...
//           }
//
//           // Get primal solution for current player
//           double[] x = new double[n];
//           for (int i=0; i<n; i++){
//             if (basis[i] < n){
//               x[basis[i]] = a[i]
